                ...
                Experiment::GM => {
                    ...
                    match &args.behavior {
                        ...
                        Behavior::Brid => {
                            ...
                            let genome: [[[u8; 10]; 6]; 10]  = [[[2, 7, 3, 0, 3, 0, 0, 2, 2, 2], [9, 9, 0, 6, 5, 1, 0, 7, 0, 0], [7, 0, 2, 0, 0, 0, 0, 0, 0, 0], [0, 8, 6, 0, 4, 2, 0, 1, 1, 6], [5, 0, 0, 0, 1, 0, 0, 0, 4, 6], [1, 3, 0, 0, 2, 0, 2, 0, 0, 0]], [[10, 4, 2, 6, 1, 1, 9, 9, 3, 0], [10, 10, 2, 7, 4, 0, 1, 9, 1, 0], [5, 0, 4, 0, 0, 6, 7, 1, 0, 2], [2, 0, 5, 6, 7, 3, 6, 0, 4, 0], [6, 4, 1, 3, 0, 1, 0, 1, 1, 0], [7, 5, 7, 0, 5, 2, 0, 0, 0, 1]], [[0, 0, 6, 1, 3, 1, 1, 2, 0, 4], [1, 2, 4, 0, 1, 6, 0, 3, 0, 7], [2, 0, 2, 0, 0, 0, 1, 1, 0, 2], [0, 0, 1, 0, 0, 3, 0, 1, 2, 0], [0, 2, 3, 0, 0, 0, 0, 0, 1, 3], [0, 0, 5, 3, 0, 0, 0, 4, 0, 6]], [[10, 3, 6, 0, 1, 1, 3, 8, 3, 1], [9, 10, 10, 6, 4, 2, 5, 8, 2, 3], [3, 0, 2, 4, 6, 1, 1, 1, 0, 0], [8, 1, 5, 7, 4, 1, 8, 2, 0, 6], [10, 0, 4, 1, 0, 5, 0, 5, 1, 1], [1, 5, 0, 1, 0, 1, 1, 4, 4, 0]], [[4, 1, 1, 4, 2, 5, 0, 3, 0, 5], [1, 3, 0, 0, 3, 0, 0, 0, 0, 2], [4, 3, 0, 0, 0, 0, 0, 1, 3, 0], [0, 0, 0, 0, 2, 0, 0, 1, 4, 1], [0, 0, 1, 0, 2, 0, 0, 5, 4, 5], [0, 0, 1, 1, 1, 2, 4, 1, 0, 0]], [[6, 0, 4, 0, 1, 8, 1, 0, 4, 0], [0, 0, 4, 0, 0, 4, 3, 2, 1, 8], [0, 0, 0, 2, 0, 0, 0, 1, 3, 1], [0, 0, 1, 0, 4, 1, 7, 1, 0, 2], [1, 0, 0, 6, 0, 0, 0, 4, 0, 0], [1, 1, 1, 5, 3, 0, 0, 0, 1, 8]], [[10, 10, 4, 0, 0, 5, 0, 2, 0, 0], [10, 10, 10, 0, 5, 3, 2, 5, 1, 1], [3, 0, 2, 0, 0, 0, 1, 1, 3, 0], [10, 10, 5, 0, 2, 0, 8, 0, 0, 0], [4, 1, 0, 3, 1, 0, 0, 0, 1, 0], [0, 2, 4, 0, 0, 3, 2, 0, 2, 1]], [[0, 0, 0, 1, 0, 0, 0, 0, 0, 2], [3, 0, 3, 0, 1, 6, 2, 1, 2, 1], [2, 1, 0, 4, 0, 2, 0, 0, 0, 0], [0, 1, 0, 1, 0, 2, 0, 0, 5, 0], [10, 0, 2, 1, 1, 10, 2, 0, 1, 2], [0, 3, 0, 0, 0, 3, 0, 6, 0, 3]], [[1, 0, 4, 0, 1, 0, 0, 1, 1, 0], [7, 0, 0, 1, 4, 3, 0, 0, 2, 0], [0, 2, 0, 1, 0, 0, 0, 2, 0, 0], [0, 0, 1, 2, 0, 0, 3, 6, 1, 3], [5, 2, 0, 3, 3, 1, 0, 0, 2, 1], [0, 0, 0, 0, 1, 0, 1, 0, 6, 7]], [[0, 0, 4, 7, 1, 2, 7, 0, 0, 3], [1, 0, 0, 1, 5, 0, 0, 0, 1, 0], [1, 0, 1, 2, 0, 4, 0, 4, 1, 1], [4, 0, 2, 0, 0, 0, 2, 4, 1, 3], [0, 3, 0, 1, 0, 2, 0, 0, 0, 0], [0, 0, 0, 5, 1, 0, 0, 1, 1, 0]]];
                            // let mut idx = 0;
                            // println!("All entries: ");
