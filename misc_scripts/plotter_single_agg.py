...
def plot_fitness_diversity(behavior, theory_fitness=None):
    ...
    fitnesses = np.loadtxt('/Users/devendra/workspace/SwarmAggregationGA/output/agg_best_t10_working.csv', ndmin = 2) #, max_rows=300)
    avg_fitnesses = np.loadtxt('/Users/devendra/workspace/SwarmAggregationGA/output/agg_avg_t10_working.csv', ndmin = 2) #, max_rows=300)
    diversity = np.loadtxt('/Users/devendra/workspace/SwarmAggregationGA/output/agg_div_t10_working.csv', ndmin = 2) #, max_rows=300)
...
plot_fitness_diversity('Agg', 0.92)